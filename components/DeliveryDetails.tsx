...
const DeliveryDetails: React.FC<SingleOrderProps> = ({ setSingleOrderPage }) => {
    ...
    return (
        <View style={tw`flex-1 flex-col gap-4 bg-[#F7F7F7] max-w-[375px]`}>
            ...
            <ScrollView style={tw`flex-1 flex-col gap-2`}>
                <View
                    style={tw`flex flex-col gap-6 text-[#5D5D5D] font-normal `}
                >
                    ...
                    <View style={tw`flex flex-col gap-6 `}>
                        <View style={tw` border border-[0.5px] rounded-lg  px-3 `}>
                            <Text
                                style={tw`text-base text-[#2A2A2A] font-medium h-10 py-2`}
                            >
                                Live Tracking
                            </Text>
                        ...
                        <View style={tw``}>
                            ...
                            <View
                                style={tw`flex-row items-center border rounded-lg px-3 bg-white ${pinInputFocus ? "border-[#00A082]" : "border-gray-300"
                                    }`}
                            >
                                <TextInput
                                    style={tw`flex-1 py-3 px-3 text-base border-0 focus:outline-none`}
                        ...
                        <Button fontWeight="medium" fullWidth={true}>Mark as Delivered</Button>
