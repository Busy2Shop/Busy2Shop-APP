...
const OrderDetails: React.FC<SingleOrderProps> = ({ setOrderPage, setSingleOrderPage }) => {
                ...
                >
                    <View style={tw`flex flex-col gap-3 `}>
                        ...
                        <View style={tw`flex flex-row gap-2 mx-auto`}>
                            <Button fontWeight="medium" onPress={handleSingleOrderPage}>Start Shopping</Button>
                            <Button
                                fontWeight="medium"
                                bgColor="bg-[#FFE6E8]"
                                textColor="[#D00416]"
